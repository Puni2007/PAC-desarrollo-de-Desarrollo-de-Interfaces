...
public class LogicaJuego {
    ...
    */   
         ...
         //Si devuelve 1 alguien gana, si devuelve 0 nadie gana
         //Compruebo horizontal
         ...
         //Si no ocurre nada de lo anterior, nadie gana devuelve 0
        return 0;
    }
    ...
    public void mostrarVentanaGanador(javax.swing.JPanel jp){
        ...
        //Concatenamos el mensaje con el condicional ternario, para saber el turno ganador
        //Como en el metodo ganador() se cambia el turno lo pongo al contrario
        String mensajeGanador = "Soy Sonia Ujaque Ortiz\nDoy la enhorabuena a las "
                +((getTurno()!=0)?"X!!!":"O!!!")
                +"\n¿Quieres continuar jugando?";
       
        /*para saber que boton clica el usuario utilizo un if, si clica el NO el programa
        se cierra*/
       if(JOptionPane.showConfirmDialog(jp, mensajeGanador,
                "Enhorabuena Ganador", JOptionPane.YES_NO_OPTION, 
    ...
    public int tiradaJugador(javax.swing.JButton bt, int x, int y, 
        ...
        //si comprobarJuego() devuelve 1 es que hay ganador
    ...
    public void ganador(javax.swing.JLabel lX, javax.swing.JLabel lO){
        ...
        //Despues hay que cambiar el turno
        cambioTurno();
    }
    ...
    public void habilitarTablero( javax.swing.JPanel jp){
        ...
        for (Component componentes : jp.getComponents())
            componentes.setEnabled(habilitado);
    ...
    private void pintarFicha(javax.swing.JButton bt){
        ...
        }else{ // Si el turno es de 1, mostrará una O en azul 
            bt.setText("O");
